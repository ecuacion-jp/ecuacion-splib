...
- `jp.ecuacion.splib:ecuacion-splib-web`
- `jp.ecuacion.splib:ecuacion-splib-jpa`
...
- javadoc - [javadoc.io](https://javadoc.io/doc/jp.ecuacion.splib/ecuacion-splib-web-jpa/latest/index.html)
