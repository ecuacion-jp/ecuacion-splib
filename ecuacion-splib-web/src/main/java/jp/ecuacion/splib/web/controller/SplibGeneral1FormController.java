...
public abstract class SplibGeneral1FormController
   ...
   */
  public SplibGeneral1FormController(String function) {
    super(function);
  }
   ...
   */
  protected SplibGeneral1FormController(String function,
  ...
  public String submitOnChangeToRefresh(Model model, @NonNull F form,
